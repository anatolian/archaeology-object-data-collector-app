...
import static cis573.com.archaeology.CheatSheet.deleteOriginalAndThumnailPhoto;
import static cis573.com.archaeology.CheatSheet.getOutputMediaFileUri;
...
import static cis573.com.archaeology.StateStatic.LOG_TAG_BLUETOOTH;
import static cis573.com.archaeology.StateStatic.LOG_TAG_WIFI_DIRECT;
import static cis573.com.archaeology.StateStatic.MARKED_AS_ADDED;
import static cis573.com.archaeology.StateStatic.MARKED_AS_TO_DOWNLOAD;
import static cis573.com.archaeology.StateStatic.MESSAGE_STATUS_CHANGE;
import static cis573.com.archaeology.StateStatic.MESSAGE_WEIGHT;
import static cis573.com.archaeology.StateStatic.REQUEST_IMAGE_CAPTURE;
import static cis573.com.archaeology.StateStatic.REQUEST_ENABLE_BT;
import static cis573.com.archaeology.StateStatic.connectedMacAddress;
import static cis573.com.archaeology.StateStatic.connectedToRemoteCamera;
import static cis573.com.archaeology.StateStatic.convertDpToPixel;
import static cis573.com.archaeology.StateStatic.getGlobalWebServerURL;
import static cis573.com.archaeology.StateStatic.getScaleTare;
import static cis573.com.archaeology.StateStatic.getTimeStamp;
import static cis573.com.archaeology.StateStatic.isBluetoothEnabled;
import static cis573.com.archaeology.StateStatic.isIsRemoteCameraSelect;
import static cis573.com.archaeology.StateStatic.isTakePhotoButtonClicked;
import static cis573.com.archaeology.StateStatic.setScaleTare;
        ...
        WiFiDirectBroadcastReceiver.WifiDirectBroadcastReceivable
{
                ...
                if (!isTakePhotoButtonClicked)
                {
                    ...
                    CameraDialog.takePhoto(StateStatic.getGlobalCameraMAC(), parentActivity, queue,
                        ...
                        public void doStuffWithSavedImage(final Uri thumbnailImageUri)
                        {
                            ...
                            AlertDialog approveDialog = CameraDialog.createPhotoApprovalDialog(parentActivity,
                                    approveDialogCallback);
                            approveDialog.show();
                            ...
                            Log.v(LOG_TAG, "Loading image " + thumbnailImageUri + " into approvePhoto Dialog done!");
                        }
                    }, getLiveViewSurface());
                }
            }
     ...
     * @param v - button
     */
    public void connectToRemoteCamera(View v)
    {
        // TODO: Needed?
    }
}