...
public class MessageConstants
{
    ...
    public static final String UNABLE_TO_LOGIN_ERROR = "Sorry, Wrong Username or password";
    ...
    public static final String FILL_ALL_FIELDS = "Please fill all the field";
    ...
    public static final String REGISTRATION_SUCCESS = "Register Sucessfully ";
    public static final String PLEASE_LOGIN = "Please Login.";
    public static final String MAIL_SEND_SUCCESS = "Mail sent successfully.";
    public static final String PLEASE_ENTER_EMAIL ="Please Entrer Email";
    ...
    public static final String SELECT_TOWN = "Please select town.";
    ...
    public static final String MIN_LIM = "Reached Minimum Limit";
}