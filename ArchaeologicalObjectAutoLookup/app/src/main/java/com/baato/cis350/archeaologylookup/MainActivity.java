...
public class MainActivity extends AppCompatActivity
{
    ...
    OkHttpClient client;
    int mode;
    public static LocalRetreiver localRetreiver;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setUpLocalDB(uD.getDatabaseLoction());
        //setUpOnlineDB("http://owainwest.me/samplejson.txt");
        Intent intent = new Intent(this, CameraUiActivity.class);
        startActivity(intent);
    }

    private void setUpLocalDB(String dbloc)
    {
        System.out.println(dbloc);
        Context context = getApplicationContext();
        localRetreiver = new LocalRetreiver(context, dbloc);
//        InputStream localIS = localRetreiver.retrieve(localRetreiver.location);
//        StringWriter writer = new StringWriter();
//        try {
//            IOUtils.copy(localIS, writer, "utf-8");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
...
/*
    private void setUpOnlineDB(String dbloc) {
        Context context = getApplicationContext();
        webRetreiver = new WebRetreiver(context, dbloc);
        InputStream onlineIS = webRetreiver.retrieve(webRetreiver.location);
        StringWriter writer = new StringWriter();
        try {
            IOUtils.copy(onlineIS, writer, "utf-8");
        } catch (IOException e) {
            e.printStackTrace();
        }
        String theString = writer.toString();
...
*/
    ...
    {
        ActivityCompat
                .requestPermissions(this, new String[]{permissionName}, permissionRequestCode);
    }
