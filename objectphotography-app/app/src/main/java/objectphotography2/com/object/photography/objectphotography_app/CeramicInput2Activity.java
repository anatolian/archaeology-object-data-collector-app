...
public class CeramicInput2Activity extends AppCompatActivity
{
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_ceramic_input2);
    ...
    /**
     * once all the data has been received you can go to the object2detailactivity, which can call
     * the camera intent
    ...
    {
        cancelAllVolleyRequests(queue);
        Intent tmpIntent = new Intent(this, ObjectDetail2Activity.class);
